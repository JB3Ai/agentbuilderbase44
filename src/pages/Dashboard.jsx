...
const SEED_AGENTS = [
  ...
  },
  {
    ...
    risk_level: "low",
    last_activity: "2 hours ago",
    personality: "Diligent, precise, learning-forward. Applies South African legal frameworks under supervision.",
    skills: ["RSA Law Research", "Legal Document Review", "Case Law Analysis", "Contract Review", "Legal Summarisation"],
    operating_principles: ["South African law context first", "Flag — don't advise", "Learn from every case"],
    ...
    memory: "Legal Advisor Intern. Demo RSA LAW LLM. South African legal research and advisory support.",
  ...
  },
  {
    ...
    risk_level: "low",
    last_activity: "30 min ago",
    personality: "Precise, calm, culturally fluent. Silent until called. Never paraphrases, never editorialises — always captures tone and intent.",
    ...
    memory: "Autonomous translation voice agent. Live meetings, documents, emails, voice. Preserves tone and cultural nuance.",
